        ...
        <div class="flex flex-1 items-center gap-2 truncate">
            ...
            @if ($hasChildren)
                <x-filament::icon-button
                 ...
                 x-bind:title="open ? '{{ trans('filament-menu-manager::menu-builder.items.collapse') }}' : '{{ trans('filament-menu-manager::menu-builder.items.expand') }}'"
                 color="gray"
