...
namespace PistacchioWeb\FilamentMenuManager\Services;
...
class MenuItemService
{
    public function __construct(
        protected FilamentMenuManagerPlugin $plugin = new FilamentMenuManagerPlugin,
    )
    {
        $this->plugin = FilamentMenuManagerPlugin::get();
    }
    ...
    public function getModelQuery(): Builder
    {
         ...
         */
        $serviceModel = app($this->getModel());
        return $serviceModel::query();
    }

    public function findById(int $id): ?Model
    {
        return $this->getModelQuery()->find($id);
    }
    ...
    {
        $query = $this->getModelQuery()->where('parent_id', $parentId);
